...
if (userCharacters.length === 0) return conn.reply(m.chat, '❀ No tiene personajes reclamados en tu harem.', m)
...
if (page < 1 || page > totalPages) return conn.reply(m.chat, `❀ Página no válida. Hay un total de *${totalPages}* páginas.`, m)
