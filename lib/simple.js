...
// Busca esta función en tu simple.js y reemplázala con esto:

export function serialize() {
    const MediaType = ['imageMessage', 'videoMessage', 'audioMessage', 'stickerMessage', 'documentMessage']
    
    // --- ESTA ES LA CORRECCIÓN ---
    // Verificamos si la propiedad 'id' ya existe en el prototipo.
    // Si existe, significa que ya se cargó y no debemos redefinirla.
    if (Object.getOwnPropertyDescriptor(proto.WebMessageInfo.prototype, 'id')) {
        return proto.WebMessageInfo.prototype
    }
    // ----------------------------
