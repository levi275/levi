...
function pickQuality(type, quality) {
    ...
    return allowed.has(q) ? q : 360; // 360p es lo mejor para velocidad en WhatsApp
}
...
// ==========================================
// 2. ADAPTADORES OPTIMIZADOS
// ==========================================

// Aceptamos 'titleOverride' para no tener que buscarlo de nuevo con yt-search
export async function ytmp3(link, titleOverride = null) {
    ...
    // Si ya nos dieron el título, lo usamos. Si no, ponemos uno genérico.
    // Quitamos la búsqueda 'yts' que ralentizaba todo.
